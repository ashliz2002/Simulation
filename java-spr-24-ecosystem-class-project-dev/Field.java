 ...
 * Each position is able to store a single object. (TODO this needs to be updated to allow multi-vegetation.)
 * 
...
public class Field
{
    ...
    /**
     * Place an object (plant or animal) at the given location.
     * If there is already an object at the location it will
     * be lost. TODO this needs to be updated to allow for multi-vegetation
     * @param object The object to be placed.
